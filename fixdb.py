...
new_cur.execute('CREATE TABLE "images" ("id" INTEGER PRIMARY KEY, "raspi_time" TEXT, "camera_time" TEXT, '
                '"gphoto_output" TEXT, "to_delete" INTEGER DEFAULT 0, "keep_forever" INTEGER DEFAULT 0);')
new_cur.execute('CREATE TABLE "files" ("id" INTEGER PRIMARY KEY, "images_id" INTEGER NOT NULL, '
                '"name" TEXT NOT NULL, "local_copy" INTEGER NOT NULL DEFAULT 1, '
                '"remote_copy" INTEGER NOT NULL DEFAULT 0);')
new_cur.execute('CREATE TABLE "tags" ("id" INTEGER PRIMARY KEY, "images_id" INTEGER NOT NULL, '
                '"name" TEXT NOT NULL, "value" TEXT);')
new_cur.execute('CREATE TABLE "climate" ("id" INTEGER PRIMARY KEY, "raspi_time" TEXT, '
